def forward_euler(f, x0, xn, y0, n):
    """
    ...
    initial value of y and n is the number of steps.
    """
    h = (xn - x0) / n
    x = x0
    y = y0
...
if __name__ == "__main__":
    print(forward_euler(lambda x, y: y, 0, 4, 1, 4))
    print(ab2(lambda x, y: y, 0, 2, 1, 4))
